...
class Article(models.Model):
    ...
    description = models.CharField(null=True, max_length=160, verbose_name='描述')
    ...
    type = models.IntegerField(null=True,default=0,verbose_name='类型')
    # 原创声明 #0非原创 1原创 2转载
    original  = models.IntegerField(null=True,default=0,verbose_name='类型')
    # 0 非热门 1热门
    hotspot  = models.IntegerField(null=True,default=0,verbose_name='热门')
